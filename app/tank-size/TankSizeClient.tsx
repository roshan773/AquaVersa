...
import { Ruler, Layers, Thermometer, Droplets, Filter, RefreshCw, ShieldCheck } from "lucide-react";
...
export default function TankSizeClient() {
    ...
    <div className="min-h-screen bg-[#f7f7ff] text-[#27187e] pt-32 text-left marine-pattern-light">
      <div className="site-container pb-20 sm:pb-24">
        ...
        <div className="mb-10 pb-8 border-b-2 border-[#cfcaf5]">
          ...
          <p className="text-base sm:text-lg text-[#27187e]/85 font-readable max-w-2xl leading-relaxed font-medium">
            Calculate precise aquarium water volume in gallons and liters, filled setup weight, substrate requirements, and recommended heater and filter ratings from custom tank dimensions.
          </p>
        </div>
