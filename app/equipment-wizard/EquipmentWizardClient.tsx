...
export default function EquipmentWizardClient() {
  ...
  const getRecommendations = () => {
    ...
    if (inputs.tankSize <= 10) {
      ...
      filterWhy = "Large tanks (40g+) require larger media volumes and flow rates to keep parameters stable. Canister filters provide maximum biological and chemical media capacity.";
    } else {
      ...
      <div className="site-container pb-20 sm:pb-24">
        ...
        <div className="mb-10 pb-8 border-b-2 border-[#cfcaf5]">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-normal text-[#27187e] tracking-tight mb-4">
            Aquarium Equipment Sizing Wizard
          </h1>
