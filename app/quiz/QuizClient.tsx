...
import { Award, CheckCircle2, XCircle, RotateCcw, ArrowRight, AlertCircle, Info } from 'lucide-react';
...
const quizQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "KH measures carbonate and bicarbonate ions. This acts as a pH buffer. If KH is too low (under 3 dKH), pH can crash rapidly, which is harmful to fish."
  },
  {
    id: 6,
