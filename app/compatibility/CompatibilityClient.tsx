...
import { Scale, Settings, Compass } from "lucide-react";
      ...
      <div className="site-container pb-20 sm:pb-24">
        ...
        <div className="mb-10 pb-8 border-b-2 border-[#cfcaf5]">
          ...
          <p className="text-base sm:text-lg text-[#27187e]/85 font-readable max-w-2xl leading-relaxed font-medium">
            Evaluate water chemistry overlap, aggressive territorial behaviors, minimum tank volumes, and plant-grazing dynamics to build a harmonious community aquarium.
          </p>
