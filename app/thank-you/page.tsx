...
export const metadata = constructMetadata({
  title: 'Message Received: Support Inquiry Submitted',
  description: 'Thank you for reaching out to Roshan Aquva World. We have received your inquiry.',
  path: '/thank-you',
  noIndex: true,
});
...
export default function ThankYouPage() {
  return (
    <div className="min-h-screen bg-[#F7F7FF] text-[#27187E] flex items-center justify-center py-24 px-4 font-readable marine-pattern-light">
      <div className="relative z-10 max-w-lg w-full text-center space-y-8 bg-[#FFFFFF] p-8 md:p-10 rounded-3xl border-2 border-[#CFCAF5] shadow-xl">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-[#27187E]/80 leading-relaxed font-medium">
            We&apos;ve successfully received your message. Our team will review your inquiry and get back to you shortly.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2 text-xs font-bold tracking-wider uppercase">
          <Link
            href="/"
