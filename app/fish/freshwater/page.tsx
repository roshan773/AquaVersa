  ...
  return (
    <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row gap-8">
      ...
      <main className="flex-1">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-poppins font-bold mb-2">Freshwater Fish</h1>
          <p className="text-muted-foreground">Discover beautiful species for your planted aquarium.</p>
        </div>
