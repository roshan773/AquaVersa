    ...
    <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row gap-8 text-left font-sans animate-pulse">
      ...
      <aside className="w-full md:w-72 shrink-0 space-y-6">
        <div className="glass p-6 rounded-2xl space-y-4">
          <div className="h-6 bg-slate-900 border border-slate-850 rounded w-1/2"></div>
          <div className="grid grid-cols-2 gap-4">
            <div className="h-16 bg-slate-900 border border-slate-850 rounded-xl"></div>
            <div className="h-16 bg-slate-900 border border-slate-850 rounded-xl"></div>
            <div className="h-12 bg-slate-900 border border-slate-850 rounded-xl col-span-2"></div>
          </div>
          <div className="space-y-2 pt-4 border-t border-slate-900">
            <div className="h-4 bg-slate-900 border border-slate-850 rounded w-3/4"></div>
