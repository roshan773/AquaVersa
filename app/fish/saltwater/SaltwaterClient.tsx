...
interface SaltwaterClientProps {
  saltwaterFish: FishType[];
}

export default function SaltwaterClient({ saltwaterFish }: SaltwaterClientProps) {
      ...
      <main className="flex-1">
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-blue-955/20 border border-blue-500/10 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6 text-left relative overflow-hidden">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl md:text-4xl font-poppins font-bold tracking-tight text-blue-400">Saltwater Marine Fish</h1>
            <p className="text-slate-400 max-w-lg leading-relaxed text-sm">
              Explore clownfish, tangs, gobies, and cardinalfish. Learn about reef requirements and marine compatibility.
            </p>
          </div>
        ...
        {filteredFish.length > 0 ? (
          ...
          <div className="text-center py-20 bg-muted/30 rounded-2xl border border-border border-dashed">
            <p className="text-muted-foreground">No saltwater fish match your current filters.</p>
            <button 
