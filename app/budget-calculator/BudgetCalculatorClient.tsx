  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4 font-sans text-foreground">
          ...
          <div className="lg:col-span-8 space-y-6 text-left">
            ...
            <div className="flex gap-3 text-xs bg-muted/40 p-4 border border-border rounded-2xl text-left text-muted-foreground">
              ...
              <div>
                ...
                Do not skimp on filtration and water testing. Biological filtration and liquid test kits are critical for preventing fish losses. You can save money initially by selecting low-tech plants that do not require specialized high-output lighting or pressurized CO2 systems.
              </div>
            </div>
      ...
      <GlobalCTA
        ...
        description="Compare specs, flow rates, and power consumption across leading canister filters, heaters, and lighting fixtures."
        primaryAction={{
