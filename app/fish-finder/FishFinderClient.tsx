...
import { HelpCircle, Check, Sparkles, ArrowRight, ArrowLeft, RefreshCw, Eye } from 'lucide-react';
...
export default function FishFinderClient() {
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto font-sans">
              Find suitable species for your aquarium. Answer 6 short questions about your setup and experience, and we will filter our library.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="bg-card border border-border rounded-3xl p-6 md:p-10 shadow-xl text-left space-y-8">
              ...
              {step === 3 && (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">We filter out sensitive species if you are starting your first aquarium.</p>
              ...
              {step === 5 && (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">Some species dig up substrates or eat soft plants, making them unsuitable for delicate planted layouts.</p>
