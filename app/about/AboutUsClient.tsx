...
export default function AboutUsClient() {
  ...
  return (
    <div className="w-full bg-[#000000] text-slate-100 min-h-screen relative overflow-hidden pb-24 text-left">
      {/* Background ambient lighting */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] bg-cyan-950/45 rounded-full blur-[140px]" />
        <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] bg-blue-955/45 rounded-full blur-[120px]" />
        <div className="absolute top-[40%] left-[20%] w-[400px] h-[400px] bg-emerald-955/20 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-28 pb-20 px-4">
          <div className="container mx-auto max-w-5xl text-center flex flex-col items-center">
            ...
            >
              <Link 
                href="/start-aquarium"
                className="px-8 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-full transition-all text-xs tracking-wider uppercase font-poppins shadow-lg shadow-blue-600/20 cursor-pointer"
              >
                Start Your Aquarium Setup →
              </Link>
            </motion.div>
        ...
        <section className="py-20 px-4 bg-slate-950/40 border-y border-slate-900/80">
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <div>
                  <div className="w-12 h-12 rounded-xl bg-cyan-950/80 border border-cyan-800/30 flex items-center justify-center text-cyan-400 mb-6 shadow-lg shadow-cyan-955/50">
            ...
            <div className="grid md:grid-cols-12 gap-12 items-center">
              ...
              >
                <Image
                  ...
                  alt="Beautiful Angelfish swimming near plants"
                  fill
              ...
              >
                ...
                <p className="text-slate-400 text-sm leading-relaxed font-light font-sans">
                  {siteConfig.name} was founded in 2026 by a beginner aquarist who grew tired of the sheer volume of conflicting, outdated, and confusing misinformation online. Too often, beginners are sold mismatched species or miniature fishbowls, leading to failed tanks and disappointed keepers.
                </p>
                ...
                <div className="bg-slate-900/30 border border-slate-850 p-6 rounded-2xl relative overflow-hidden backdrop-blur-sm">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-wider text-cyan-400 mt-3">— {siteConfig.name} Philosophy</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-12 px-4 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute right-0 bottom-0 w-[300px] h-[300px] bg-cyan-955/20 rounded-full blur-[80px] pointer-events-none" />
            ...
            <div className="shrink-0">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold rounded-xl transition-all duration-300 shadow-lg shadow-cyan-500/10 hover:shadow-cyan-500/20 text-sm group cursor-pointer"
              >
