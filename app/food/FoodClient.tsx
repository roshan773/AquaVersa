...
export default function FoodClient({ initialFood }: FoodClientProps) {
  const [foodList] = useState<FoodType[]>(initialFood);
      ...
      <div className="site-container pb-20 sm:pb-24">
        ...
        <div className="mb-10 pb-8 border-b-2 border-[#cfcaf5]">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-normal text-[#27187e] tracking-tight mb-4">
            Aquarium Fish Food &amp; Nutrition Guide
          </h1>
          <p className="text-base sm:text-lg text-[#27187e]/85 max-w-2xl leading-relaxed font-medium">
            Learn proper protein-to-fiber ratios, sinking vs floating behaviors, and live or frozen supplementation to maintain vibrant fish coloration and longevity.
          </p>
