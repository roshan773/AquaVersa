...
export default function GuidesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7ff] text-[#27187e] text-left font-sans">
      <section className="pt-32 pb-24 marine-pattern-light">
      ...
      <GlobalCTA
        badge="SYSTEMATIC AQUARIUM CURRICULUM"
        title={
          <>
            Test your knowledge with the <br className="hidden sm:inline" />
            Aquarium Science Quiz.
          </>
        }
        description="Verify your understanding of biological filtration, parameter testing, and safe stocking to earn verified achievements."
        primaryAction={{
          label: 'Take Science Quiz',
          href: '/quiz',
        }}
        secondaryAction={{
          label: 'Start 5-Step Tank Setup',
          href: '/start-aquarium',
        }}
      />
    </div>
