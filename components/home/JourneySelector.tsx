    ...
    <section className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8 relative z-10 max-w-6xl">
        {journeys.map((j, i) => (
          <div
            key={i}
            className="p-8 rounded-2xl bg-black border border-blue-500/10 hover:border-blue-500/35 transition-all duration-300 shadow-sm hover:shadow-[0_8px_30px_rgba(59,130,246,0.1)] transform hover:-translate-y-1 text-left"
          >
            ...
            <Link
              href={j.href}
              className="inline-flex items-center gap-2 text-blue-500 hover:text-blue-400 font-bold text-sm tracking-wider uppercase transition-colors group cursor-pointer"
            >
