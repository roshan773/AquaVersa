    ...
    <section className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8 relative z-10 max-w-6xl">
        {journeys.map((j, i) => (
          <div
            key={i}
            className="p-8 rounded-2xl bg-black border border-red-500/10 hover:border-red-500/35 transition-all duration-300 shadow-sm hover:shadow-[0_8px_30px_rgba(239,68,68,0.1)] transform hover:-translate-y-1"
          >
