        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => {
            ...
            return (
              <div 
                key={i} 
                className="relative overflow-hidden group p-6 rounded-2xl bg-black border border-red-500/10 hover:bg-black/60 transition-all duration-500 hover:border-red-500/35 transform hover:-translate-y-1 shadow-sm flex flex-col justify-between min-h-[190px] text-left"
              >
