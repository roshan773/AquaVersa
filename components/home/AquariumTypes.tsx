...
export default function AquariumTypes() {
  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden border-b border-slate-900">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(59,130,246,0.02),transparent_70%)] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {types.map((type) => (
            <Link 
              href={type.href} 
              key={type.id} 
              className="group text-left rounded-3xl border border-blue-500/10 bg-black/40 overflow-hidden hover:border-blue-500/35 hover:shadow-[0_8px_30px_rgba(59,130,246,0.1)] hover:-translate-y-1 transition-all duration-300 block cursor-pointer"
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2 text-white group-hover:text-blue-500 transition-colors">{type.title}</h3>
