...
export default function Navbar() {
  ...
  const linkClass = "text-sm font-semibold tracking-wide transition-all duration-300 hover:text-red-500 text-white/90";
  const btnClass = "text-sm font-semibold tracking-wide transition-all duration-300 flex items-center gap-1 hover:text-red-500 text-white/90 focus:outline-none";

  return (
    <nav className={`sticky top-0 z-50 w-full transition-all duration-300 ${
      isScrolled
        ? "bg-black/90 backdrop-blur-md border-b border-red-500/20 shadow-[0_4px_20px_rgba(239,68,68,0.05)] py-2"
            ...
            <AnimatePresence>
              {activeDropdown === 'fish' && (
                <motion.div
                  ...
                  className="absolute top-16 left-1/2 -translate-x-1/2 w-[800px] bg-black/95 backdrop-blur-md border border-red-500/25 rounded-2xl p-6 shadow-[0_10px_40px_rgba(239,68,68,0.15)] grid grid-cols-2 gap-6 z-50 text-left"
                >
                  <div className="group flex flex-col gap-3 p-4 rounded-xl hover:bg-white/5 transition-all border border-transparent hover:border-red-500/20 text-white">
                    <Link href="/fish/freshwater" className="block relative w-full h-32 rounded-lg overflow-hidden bg-slate-900 border border-red-500/10">
                      <Image
                        ...
                        sizes="350px"
                      />
                      <div className="absolute top-3 left-3 bg-black/80 backdrop-blur-sm p-1.5 rounded-md border border-red-500/20">
                        <Droplets className="w-4 h-4 text-cyan-500" />
                      </div>
                    </Link>
                    <div>
                      <Link href="/fish/freshwater" className="inline-block group-hover:text-red-500 transition-colors">
                      ...
                      <p className="text-xs font-semibold text-red-500 mt-2 mb-3">{fwFish.length} Species Available</p>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-2 pt-2 border-t border-slate-800">
                        {fwFish.slice(0, 6).map((fish) => (
                          <Link
                            ...
                            className="text-xs text-slate-400 hover:text-red-550 transition-colors truncate"
                  ...
                  <div className="group flex flex-col gap-3 p-4 rounded-xl hover:bg-white/5 transition-all border border-transparent hover:border-red-500/20 text-white">
                    <Link href="/fish/saltwater" className="block relative w-full h-32 rounded-lg overflow-hidden bg-slate-900 border border-red-500/10">
                      <Image
                    ...
                    <div>
                      <Link href="/fish/saltwater" className="inline-block group-hover:text-red-500 transition-colors">
                      ...
                      <p className="text-xs font-semibold text-red-550 mt-2 mb-3">{swFish.length} Species Available</p>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-2 pt-2 border-t border-slate-800">
            ...
            <AnimatePresence>
              {activeDropdown === 'guides' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10, scale: 0.95 }}
                  transition={{ duration: 0.2 }}
                  className="absolute top-16 left-1/2 -translate-x-1/2 w-48 bg-black/95 backdrop-blur-md border border-red-500/25 rounded-2xl p-3 shadow-[0_10px_40px_rgba(239,68,68,0.15)] z-50 text-left flex flex-col gap-1.5"
                >
            ...
            <AnimatePresence>
              {activeDropdown === 'tools' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10, scale: 0.95 }}
                  transition={{ duration: 0.2 }}
                  className="absolute top-16 right-0 w-[480px] bg-black/95 backdrop-blur-md border border-red-500/25 rounded-2xl p-5 shadow-[0_10px_40px_rgba(239,68,68,0.15)] z-50 text-left grid grid-cols-2 gap-x-6 gap-y-1.5"
                >
                  <div className="col-span-2 border-b border-slate-800 pb-2 mb-2 font-bold text-xs text-red-500 uppercase tracking-wider">
                    Interactive Toolkit
                  </div>
                  ...
                  <Link href="/achievements" className="p-2 text-xs font-bold text-red-500 hover:text-red-400 rounded-lg col-span-2 border-t border-slate-800 mt-2 pt-2 text-center" onClick={() => setActiveDropdown(null)}>🏆 View Your Achievements</Link>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
        ...
        <div className="flex items-center gap-4">
          <form onSubmit={handleSearchSubmit} className="relative">
            ...
            <input
              ...
              className="w-28 sm:w-36 lg:w-48 pl-10 pr-4 py-2 rounded-full border text-sm transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-500 bg-white/10 text-white placeholder-white/50 border-white/20 focus:bg-white/20"
            />
          </form>
          ...
          <>
            ...
            >
              <div className="flex flex-col p-6 gap-6 text-left">
                <Link href="/" className="font-semibold text-lg hover:text-red-500 transition-colors text-white" onClick={toggleMobileMenu}>Home</Link>

                <div className="border-t border-slate-850 pt-4">
                  <span className="text-slate-400 text-xs uppercase tracking-wider font-bold mb-3 block">Species Library</span>
                  <div className="flex flex-col gap-3 pl-2">
                    <Link href="/fish/freshwater" className="font-semibold text-base hover:text-red-500 transition-colors flex items-center gap-2 text-slate-200" onClick={toggleMobileMenu}>
                      <Droplets className="w-5 h-5 text-cyan-500" /> Freshwater Fish
                    </Link>
                    <Link href="/fish/saltwater" className="font-semibold text-base hover:text-red-500 transition-colors flex items-center gap-2 text-slate-200" onClick={toggleMobileMenu}>
                      <Anchor className="w-5 h-5 text-red-500" /> Saltwater Fish
                    </Link>
                    <Link href="/plants" className="font-semibold text-base hover:text-red-500 transition-colors flex items-center gap-2 text-slate-200" onClick={toggleMobileMenu}>
                      <LeafIcon className="w-5 h-5 text-emerald-500" /> Aquatic Plants
                    </Link>
                    <Link href="/equipment" className="font-semibold text-base hover:text-red-500 transition-colors flex items-center gap-2 text-slate-200" onClick={toggleMobileMenu}>
                ...
                <div className="border-t border-slate-850 pt-4">
                  ...
                  <div className="flex flex-col gap-3 pl-2 text-slate-350">
                    <Link href="/start-aquarium" className="text-sm font-semibold hover:text-red-500" onClick={toggleMobileMenu}>• First Setup Guide</Link>
                    <Link href="/water-params" className="text-sm font-semibold hover:text-red-500" onClick={toggleMobileMenu}>• Water Chemistry Guide</Link>
                    <Link href="/diseases" className="text-sm font-semibold hover:text-red-500" onClick={toggleMobileMenu}>• Diseases & Treatments</Link>
                  </div>
                </div>
                ...
                <div className="border-t border-slate-850 pt-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 pl-2 text-sm font-semibold text-slate-350">
                    <Link href="/tank-size" className="hover:text-red-500" onClick={toggleMobileMenu}>📐 Aquarium Calculator</Link>
                    <Link href="/water-analyzer" className="hover:text-red-500" onClick={toggleMobileMenu}>🧪 Water Analyzer</Link>
                    <Link href="/compatibility" className="hover:text-red-500" onClick={toggleMobileMenu}>⚖️ Compatibility Checker</Link>
                    <Link href="/stocking-planner" className="hover:text-red-500" onClick={toggleMobileMenu}>📊 Stocking Planner</Link>
                    <Link href="/fish-finder" className="hover:text-red-500" onClick={toggleMobileMenu}>🔍 Fish Recommendation</Link>
                    <Link href="/equipment-wizard" className="hover:text-red-500" onClick={toggleMobileMenu}>⚙️ Equipment Wizard</Link>
                    <Link href="/budget-calculator" className="hover:text-red-500" onClick={toggleMobileMenu}>💵 Budget Calculator</Link>
                    <Link href="/aquascape-planner" className="hover:text-red-500" onClick={toggleMobileMenu}>🪵 Aquascape Planner</Link>
                    <Link href="/symptom-checker" className="hover:text-red-500" onClick={toggleMobileMenu}>🩺 Symptom Checker</Link>
                    <Link href="/quiz" className="hover:text-red-500 border-t border-slate-800 pt-3 mt-1" onClick={toggleMobileMenu}>🎓 Aquarium Quiz</Link>
                    <Link href="/achievements" className="text-red-500 font-bold" onClick={toggleMobileMenu}>🏆 View Achievements</Link>
                  </div>
                </div>
              </div>
            </motion.div>
